...
```json
{
  "source": "E:\\11_mm-rag-1.0\\data\\Client_Contracts_Policies_and_Incident_Records.pdf",
  "page_number": 1,
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_001.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_002.png"
}
```
...
‘Arka Finance MSA, audit addendum, DPA High Legal and compliance
BlueLeat Retail MSA, pricing, support SLA Medium Procurement
CityRide Mobility Ops reports, incident logs, Medium Operations
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_003.png"
}
```
...
WEB-FAQ-008 Shared HTML 23 pages
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_004.png"
}
```
...
72 Confidentiality Receiving Party Receipt of confidential Protect information with reasonable care Page 4, clause
material and equivalent internal controls 72
4 Data residency Service Provider. SOW specifies region Process production records only in Page 4, clause
approved region 94
11.4 Termination Service Provider Agreement Provide export window for 30 days Page 4, clause
assistance termination 114
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_005.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_006.png"
}
```
...
API Availability P'1 - complete 15 minutes 4 hours 10 percent monthly Monitoring logs and incident
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_007.png"
}
```
...
Raw Files Parser Chunks Vector DB
PDF / DOCX / HT! Text + Tables Sections + Metadata Embeddings

User Query Retriever LLM
question top-k chunks grounded answer
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_008.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_009.png"
}
```
...
Client Name BlueLeat Retail Pvt Ltd Must match known client list
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_010.png"
}
```
...
BLR-MSA-001 Master Service BLR-ACME-2026
Agreement

BLR-NDA-002 NDA BLR-ACME-2026
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_011.png"
}
```
...
tenant Retrieval and Access Control

Authentication Identity user and organization Unknown user may access application
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_012.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_013.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_014.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_015.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_016.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_017.png"
}
```
...
India Region | international

Base INR 4.5L. USD 7,200
Support INR 60K

Base INR TIL | usb 18,000
Support INR 1.4L
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_018.png"
}
```
...
‘Summary ‘Subtotal and taxes : LINR 14,16,000 INR 127,440 | INR1,27,440 _ INR 16,70,880
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_019.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_020.png"
}
```
...
Complex RAG Parsing Sample - appended visuals and scanned documents Appendix page 2
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_021.png"
}
```
...
Complex RAG Parsing Sample - appended visuals and scanned documents Appendix page 3
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_022.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_023.png"
}
```
...
Energy usage - peak units

Energy usage - off-peak units
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\page_images\\page_024.png"
}
```
...
SELECTABLE TEXT:
Complex RAG Parsing Sample - appended instructor image
Appendix page 6
Appendix I: Profile Image for Multimodal Parsing
This page adds a portrait-style image to test how a parser or multimodal RAG system handles photographic
content, captions, image metadata, and surrounding text. Text-only loaders may extract the caption but cannot
understand the visual content unless OCR, vision, or multimodal parsing is used.
Caption: Portrait-style instructor image with a bright background. Useful for testing image extraction, captioning,
person detection, layout preservation, and multimodal document understanding.
Element
Parsing Challenge
Expected Handling
Portrait image
Pixels are not selectable PDF text.
Extract image object or create visual summary with a
multimodal model.
Caption text
Caption should stay attached to image
context.
Preserve caption near the image in reading order.
Image metadata
File name, page, and bounding box may be
needed.
Store metadata for citation and retrieval.
RAG usage
Text-only chunks may miss visual details.
Use OCR or vision captioning before chunking if
...
sing Challenge Expected Handling

Element

Pixels are not selectable PDF text. Extract image object or create visual summary with a

Portrait image
multimodal model.

Caption text Caption should stay attached to image Preserve caption near the image in reading order.
context.

Image metadata File name, page, and bounding box may be Store metadata for citation and retrieval.
needed.

RAG usage Text-only chunks may miss visual details. Use OCR or vision captioning before chunking if
...
|:---------------|:------------------------------------------|:-----------------------------------------------------|
| Portrait image | Pixels are not selectable PDF text.       | Extract image object or create visual summary with a |
|                |                                           | multimodal model.                                    |
| Caption text   | Caption should stay attached to image     | Preserve caption near the image in reading order.    |
|                | context.                                  |                                                      |
| Image metadata | File name, page, and bounding box may be  | Store metadata for citation and retrieval.           |
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\extracted_images\\page_002_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: E:\11_mm-rag-1.0\data\parsed_pdf_output\extracted_images\page_002_image_1.png

IMAGE OCR TEXT:
Contract Processing Ownership Map

Client Admin Audit Team
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\extracted_images\\page_007_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: E:\11_mm-rag-1.0\data\parsed_pdf_output\extracted_images\page_007_image_1.png

IMAGE OCR TEXT:
RAG Ingestion and Retrieval Flow

Raw Files Parser Chunks Vector DB
PDF / DOCX / HTML Text + Tables Sections + Metada| Embeddings
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\extracted_images\\page_009_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: E:\11_mm-rag-1.0\data\parsed_pdf_output\extracted_images\page_009_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\extracted_images\\page_012_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: E:\11_mm-rag-1.0\data\parsed_pdf_output\extracted_images\page_012_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\extracted_images\\page_016_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: E:\11_mm-rag-1.0\data\parsed_pdf_output\extracted_images\page_016_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\extracted_images\\page_017_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: E:\11_mm-rag-1.0\data\parsed_pdf_output\extracted_images\page_017_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\extracted_images\\page_018_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: E:\11_mm-rag-1.0\data\parsed_pdf_output\extracted_images\page_018_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\extracted_images\\page_019_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: E:\11_mm-rag-1.0\data\parsed_pdf_output\extracted_images\page_019_image_1.png
...
Scanned ext + Table: RAG-ready
Invoices + Metadata Chunks
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\extracted_images\\page_020_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: E:\11_mm-rag-1.0\data\parsed_pdf_output\extracted_images\page_020_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\extracted_images\\page_021_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: E:\11_mm-rag-1.0\data\parsed_pdf_output\extracted_images\page_021_image_1.png
...
audit log
Red boundary = tenant-safe processing zone. Ret! authenticated client_id
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\extracted_images\\page_022_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: E:\11_mm-rag-1.0\data\parsed_pdf_output\extracted_images\page_022_image_1.png
...
Annual platform subscription INR 95,000 95,000

Implementation and onboarding INR 22,500 22,500

Support add-on / message pack INR 0.40 1,400
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\extracted_images\\page_023_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: E:\11_mm-rag-1.0\data\parsed_pdf_output\extracted_images\page_023_image_1.png
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "E:\\11_mm-rag-1.0\\data\\parsed_pdf_output\\extracted_images\\page_024_image_1.jpeg",
  "image_ext": "jpeg"
}
```
...
IMAGE INDEX: 1
IMAGE PATH: E:\11_mm-rag-1.0\data\parsed_pdf_output\extracted_images\page_024_image_1.jpeg
